   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge"> 
	...
	function fnGetList(sGetToken){		 
			...
			var sTargetUrl = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=relevance"
								+ "&q="+ encodeURIComponent($getval) +"&key=AIzaSyCHB4wFMSS067PsIk4UZBSbqg4yQLIS3U8";
			if(sGetToken){
			...
			$.ajax({
				...
				success: function(jdata) {
					...
					$(jdata.items).each(function(i){
						...
						$("#get_view").append("<p class='box'><a href='https://youtu.be/"+this.id.videoId+"' target='_blank'><img src='"
								+this.snippet.thumbnails.default.url+"'><span>"+this.snippet.title+"</span></a></p>");
